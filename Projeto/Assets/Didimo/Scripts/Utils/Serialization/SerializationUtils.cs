...
namespace Didimo.Utils.Serialization
{
    ...
    {
        public static string SerilizedFieldName(FieldInfo field)
        {
            string fieldName = field.Name;

            JsonNameAttribute jsonNameAttr = Attribute.GetCustomAttribute(field, typeof(JsonNameAttribute)) as JsonNameAttribute;
            if (jsonNameAttr != null)
            {
                fieldName = jsonNameAttr.Name;
            }
