...
v2f didimoVert(appdata i)
{
  ...
  o.cP = mul(UNITY_MATRIX_VP, float4(o.wP + o.wV * lerp(0, 0.01, zBias), 1));
...
v2f didimoSkinVert(appdata i)
{
  ...
  fixed zBiasMask = tex2Dlod(zBiasSampler, float4(i.uv, 0, 0)).r;

  o.cP = mul(UNITY_MATRIX_VP, float4(o.wP + o.wV * lerp(0, 0.01, zBias * zBiasMask), 1));
...
struct DidimoOut
{
  fixed4 main : SV_Target0;
  fixed4 skin : SV_Target1;
};
